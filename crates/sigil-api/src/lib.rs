...
pub fn router(state: AppState) -> Router {
    ...
    Router::new()
        ...
        .route("/v1/court/case/appeal", post(court::court_appeal))
        .route("/v1/court/case/decide_appeal", post(court::court_decide_appeal))
        ...
        .route("/v1/rocky", get(nation::rocky_status))
        .route("/v1/rocky/call_wallet", post(nation::rocky_call_wallet))
