...
\fancyhead[L]{\scriptsize\textcolor{gray}{The Word and the Ledger --- verifiable commitment provenance \,$\cdot$\, v0.1}}
\fancyhead[R]{\scriptsize\textcolor{gray}{\thepage}}

\hypersetup{
  pdftitle={The Word and the Ledger — Verifiable Commitment Provenance for SIGIL (v0.1)},
...
Nothing below invents a primitive. The contribution is naming the record, fixing its
