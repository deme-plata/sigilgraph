...
const widths = [[360, 640], 390, 820, 1024, 1440, 1600, 1920, [2560, 1200], [844, 390]] // 1600 = the tightest panel-auto-open layout (main 1156px), where the trending table clipped on 09-16; [844,390] = phone landscape, where the collection sheet had no room for its items (tick 274)
const fails = []
